...
class PaymentHelper {
    ...
    createOrder(order_id, amount, item_name, items, profile_id, email_address, phone, full_name) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const create = yield axios_1.default.post(`${process.env.PAYMENT_BASE_ENDPOINT}/pg/orders`, data, config);
                const response_data = create.data;
    ...
    createReceipt(name, title, amount, date, qrtext) {
        return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
            ...
            const avatarImage = yield axios_1.default.get('http://localhost:4566/other-images/9189.jpg', { responseType: "arraybuffer" });
            const signBuffer = yield axios_1.default.get('http://localhost:4566/other-images/sign.png', { responseType: "arraybuffer" });
