...
class SDK {
     ...
     */
    removeBeneficiary(body, metadata) {
     ...
     */
    internalTransfer(body, metadata) {
     ...
     */
    internalTransfer_v12(body, metadata) {
     ...
     */
    requestAsyncTransfer(body, metadata) {
     ...
     */
    requestBatchTransfer(body, metadata) {
     ...
     */
    getBatchTransferStatus(metadata) {
     ...
     */
    requestTransfer_v12(body, metadata) {
     ...
     */
    requestAsyncTransfer_v12(body, metadata) {
     ...
     */
    directTransfer_v12(body, metadata) {
     ...
     */
    getTransferStatus_v12(metadata) {
     ...
     */
    requestBatchTransfer_v12(body, metadata) {
     ...
     */
    getBatchTransferStatus_v12(metadata) {
     ...
     */
    deactivateCashgram(body, metadata) {
